...
if('IntersectionObserver' in window){
  var rio=new IntersectionObserver(function(es){es.forEach(function(e,i){if(e.isIntersecting){setTimeout(function(){e.target.classList.add('in');},i*60);rio.unobserve(e.target);}});},{threshold:.08,rootMargin:'0px 0px -30px 0px'});
